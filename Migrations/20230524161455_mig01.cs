        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTamam = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Parametrelers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Parametrelers_Grups_GrupId",
                        column: x => x.GrupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaslikCites = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicationInfo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_YayinAlintiBilgisis_PersonelYayinBilgileris_YayinId",
                        column: x => x.YayinId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_YayinAlintiBilgisis_YayinId",
